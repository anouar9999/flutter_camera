...
class Third_camera_screen extends StatefulWidget {
  final List<CameraDescription> cameras;
  const Third_camera_screen({super.key, required this.cameras});

  @override
  State<Third_camera_screen> createState() => _Third_camera_screenState();
}

class _Third_camera_screenState extends State<Third_camera_screen> {
  ...
  void takePicture() async {
    ...
    // Navigator.push(
    //   context,
    //   MaterialPageRoute(builder: (context) => FullScreenImageToggleable()),
    // );
